...
Calendar.prototype.bindData = function () {
 ...
 var tds = this.getElementsByTagName_r("td", this.getElementById("__calendarTable", this.iframe.document));
...
Calendar.prototype.getElementById = function(id, object){
 ...
 return document.getElementByIdx ? object.getElementById(id) : document.all(id);
};
