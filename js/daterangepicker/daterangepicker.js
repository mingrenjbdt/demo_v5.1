        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' + '<button style="float:right;" class="' + this.cancelClass + ' cancelBtn">' + this.locale.cancelLabel + '</button>' 
                     +'<button style="float:right;" class="' + this.applyClass + ' applyBtn " disabled="disabled">' + this.locale.applyLabel + '</button>&nbsp;'
                   +
                  '</div>' +
                '</div>' +
              '</div>';
